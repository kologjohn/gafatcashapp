                              ...
                              Expanded(
                                child: TextFormField(
                                  ...
                                  decoration:  const InputDecoration(
                                      hintText: "Grams",
                                      labelStyle: TextStyle(color: Colors.white54, fontSize: 16),
                            ...
                            children: [
                              Expanded(
                                ...
                                child: ElevatedButton(
                                  ...
                                  child: const Text("Save Record",style: TextStyle(color: Colors.green),),
                                ),
                              ),
                            ],
                          ),
